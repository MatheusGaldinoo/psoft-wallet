...
public class CompraControllerTests {
    ...
    class AcompanharStatusCompras {
        ...
        void clienteComCompraSolicitada() throws Exception {
            ...
            driver.perform(
                            post(URI_COMPRAS_CLIENTES + "/" + cliente.getId() + "/compra")
        ...
        void clienteComComprasSolicitaDisponivelEmCarteira() throws Exception {
            ...
            driver.perform(post(URI_COMPRAS_CLIENTES + "/" + cliente.getId() + "/compra")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(compraSolicitacaoJson))
                    .andExpect(status().isCreated())
                    .andDo(print())
    ...
    class SolicitarCompra {
        ...
        void compraValidaParaPlanoPremium() throws Exception {
            ...
            String responseJsonString = driver.perform(post("/clientes/" + idCliente + "/compra")
                            .content(json)
                            .contentType(MediaType.APPLICATION_JSON))
                    .andExpect(status().isCreated())
                    .andDo(print())
        ...
        void quandoClienteNaoExiste() throws Exception {
            ...
            driver.perform(post("/clientes/" + idClienteInexistente + "/compra")
                            .content(json)
                            .contentType(MediaType.APPLICATION_JSON))
                    .andExpect(status().isBadRequest())
                    .andDo(print());
        ...
        void quandoCodigoDeAcessoInvalido() throws Exception {
            ...
            driver.perform(post("/clientes/" + idCliente + "/compra")
                            .content(json)
                            .contentType(MediaType.APPLICATION_JSON))
                    .andExpect(status().isBadRequest())
                    .andDo(print());
