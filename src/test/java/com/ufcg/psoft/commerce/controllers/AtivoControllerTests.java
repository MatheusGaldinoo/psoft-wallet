...
public class AtivoControllerTests {
    ...
    class ExcluirAtivo {
        ...
        void deveExcluirAtivoExistente() throws Exception {
            ...
            driver.perform(
                            delete(URI_ATIVOS + "/" + ativo.getId())
                                    .param("codigoAcesso", CODIGO_ACESSO_VALIDO))
                    .andExpect(status().isNoContent())
                    .andDo(print());

            // Verificar se o ativo foi realmente excluído
